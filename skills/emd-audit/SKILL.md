...
Signale toute paire trop similaire (même type de home ET palette proche, **logo/éclair inline identique**, ou **même auteur/bio réutilisés**).
...
- **Détail par site** trié par sévérité ; mets en avant : bandeau cookies / pages légales (placeholders) manquants, scroll horizontal, **auteur générique « la rédaction »**, **logo inline générique**, **articles sous 70 % de H2-questions (% mesuré)**, thin content, covers de catégorie non rendues, cannibalisation, JSON-LD manquant.
